...
const localStorageMock = {
  getItem: jest.fn(function () {
    return '{"projects":[{"name":"GENERAL TASKS","tasks":[{"name":"Welcome to Tikky","description":"Thanks for trying out the App, I hope it helps you to achieve your task planning and monitoring goals","dueDate":"2021-06-06","priority":"low","completed":false}]},{"name":"TEST PROJECT","tasks":[]}]}';
  }),
  setItem: jest.fn(),
  clear: jest.fn()
};
